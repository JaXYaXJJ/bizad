    ...
    <>
      <div className="topContainer p-5">
        ...
        <h3 className="d-flex justify-content-center">
          Work and chill with us
        </h3>
      </div>
      <div className="container">
        <div className="aboutBizAd card">
          <img
            className="card-img"
            src="https://images.pexels.com/photos/7278829/pexels-photo-7278829.jpeg"
            alt="Card image"
          />
          <div className="card-img-overlay">
            <h5 className="card-title">BizAd</h5>
